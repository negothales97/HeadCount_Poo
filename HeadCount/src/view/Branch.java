...
public class Branch {
	...
	public static void main(String[] args) {
		...
		JLabel labelTrade 				= new JLabel("Razão Social");
		...
		JLabel labelStateIns 			= new JLabel("Inscrição Estadual");
		JTextField inputStateIns 		= new JTextField(5);
		
		JLabel labelMunicipalIns 		= new JLabel("Inscrição Municipal");
		...
		janela.add(panel);
		// Quando a janela for fechada, a aplicação será parada
